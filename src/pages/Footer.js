    ...
    <footer>
      <>
        <div className="bg-base-200">
          <div className="footer py-8 p-10 bg-base-200 text-base-content justify-around">
            <div>
            ...
            <div className="align-center">
              ...
              <div className="flex ">
                <a
                  ...
                  className="text-3xl text-primary cursor-pointer mx-3"
                >
                  <ImFacebook2 />
                </a>
                <a
          ...
          <div className="text-center pb-16 ">
            <p className=" text-black-700 copy text-lg">
